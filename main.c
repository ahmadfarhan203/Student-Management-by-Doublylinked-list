//Student Management System using DoublyLinkedList
#include<stdlib.h>
#include<string.h>
#include<stdio.h>
struct Student
...
void insert(int rollnumber, char* name, char* phone, float percentage)
{
    ...
    if(head==NULL){
        ...
        student->next = head;
        student->prev = NULL;
        // set prev of head to new node or student
        if(head!=NULL){
              head->prev=student;
        }
        head = student;
...
//Search the roll no. and print details
